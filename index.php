...
<body>
    ...
    <main>
        <?php foreach($faqs as $faq) { 
                foreach($faq as $question_answer => $text){
                if ($question_answer == "question"){
                    echo "<h2>{$text}</h2>";
                } elseif($question_answer == "answer"){
                    echo "<div>{$text}</div>";
                }
                }
            }
